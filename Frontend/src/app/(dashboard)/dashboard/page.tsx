  ...
  return (
    <>
      ...
      <div className="md:hidden">
              ...
              return (
                ...
                >
                  ...
                  {loading ? (
                    ...
                    <p className="text-base sm:text-lg font-bold truncate" style={{ color: "var(--color-text-1)" }}>
                      {value}
                    </p>
                  )}
                  <p className="text-[10px] sm:text-xs mt-0.5 truncate" style={{ color: "var(--color-text-3)" }}>
                    {s.title}
                  </p>
                </div>
              );
        ...
        {/* Recent transactions */}
        <div className="px-3 sm:px-4 mt-5 sm:mt-6 pb-4">
          <p
            className="text-xs font-mono tracking-widest uppercase mb-3"
            style={{ color: "var(--color-text-3)" }}
          >
          ...
          >
            {walletLoading ? (
                ...
                {wallet.transactions.slice(0, 5).map((tx) => (
                  <div key={tx.id} className="flex items-center justify-between gap-2">
                    <div className="flex items-center gap-2.5 sm:gap-3 min-w-0 flex-1">
                      ...
                      >
                        <TrendingUp
                          className={`h-4 w-4 ${tx.transaction_type === "debit" ? "rotate-180" : ""}`}
                          style={{
                            color:
                              tx.transaction_type === "credit"
                                ? "var(--color-success)"
                      ...
                      <div className="min-w-0 flex-1">
                        <p className="font-medium text-xs sm:text-sm truncate" style={{ color: "var(--color-text-1)" }}>
                          {tx.description || "Transaction"}
                        </p>
                        <p className="text-[10px] sm:text-xs" style={{ color: "var(--color-text-3)" }}>
              ...
              <p className="text-xs sm:text-sm text-center py-4" style={{ color: "var(--color-text-3)" }}>
                No transactions yet
              </p>
            )}
          </div>
