    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <View style={styles.emptyCard}>
          ...
          <Text style={styles.emptyTitle}>Voice & Video Calls</Text>
          <Text style={styles.emptyText}>Start voice or video calls with your friends and downline members. Coming soon!</Text>
        </View>
      </View>
      ...
      <View style={styles.bottomNav}>
        ...
        <TouchableOpacity style={styles.navItem}>
          ...
          <Text style={styles.activeNavLabel}>Calls</Text>
        </TouchableOpacity>
