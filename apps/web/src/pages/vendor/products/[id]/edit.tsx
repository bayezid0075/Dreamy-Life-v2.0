          ...
          <form onSubmit={handleSubmit} className="space-y-8 flex flex-col">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
              ...
              <div className="md:col-span-7 space-y-6">
                <div className="flex flex-col gap-2">
                  ...
                  <input type="text" value={form.name} onChange={e => setForm({ ...form, name: e.target.value })} required
                    className="w-full bg-white/50 backdrop-blur-[12px] border border-white/40 rounded-full px-6 py-4 text-[#1c1b1b] focus:bg-white/80 focus:border-[#98d0d7] focus:ring-4 focus:ring-[#98d0d7]/20 outline-none transition-all" />
                </div>
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="relative">
                      ...
                      <input type="number" step="0.01" value={form.price} onChange={e => setForm({ ...form, price: e.target.value })} required
                        className="w-full bg-white/50 backdrop-blur-[12px] border border-white/40 rounded-full pl-10 pr-6 py-4 text-[#1c1b1b] focus:bg-white/80 focus:border-[#98d0d7] focus:ring-4 focus:ring-[#98d0d7]/20 outline-none transition-all" />
                    </div>
                  </div>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-12 flex flex-col gap-2 mt-2">
                ...
                <textarea value={form.description} onChange={e => setForm({ ...form, description: e.target.value })} rows={5}
                  className="w-full bg-white/50 backdrop-blur-[12px] border border-white/40 rounded-2xl px-6 py-4 text-[#1c1b1b] resize-none focus:bg-white/80 focus:border-[#98d0d7] focus:ring-4 focus:ring-[#98d0d7]/20 outline-none transition-all" />
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row justify-end items-center gap-4 pt-8 mt-8 border-t border-white/20">
              <button type="button" onClick={() => router.back()}
                className="w-full sm:w-auto px-8 py-4 rounded-full bg-white/50 text-[#1c1b1b] text-sm font-semibold hover:bg-white/60 transition-all active:scale-95 border border-white/30">
                Cancel
              </button>
