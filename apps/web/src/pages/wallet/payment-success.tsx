...
export default function PaymentSuccessPage() {
  ...
  useEffect(() => {
    const processPayment = async () => {
      ...
      try {
        const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:4080'}/wallet/payment-success`, {
          method: 'POST',
        ...
        if (res.ok && data.success) {
          setStatus('success');
          setMessage('Your funds have been added successfully!');
          setTimeout(() => {
  ...
  return (
    <>
      <Head>
        <title>Payment {status === 'success' ? 'Successful' : status === 'error' ? 'Failed' : 'Processing'} - Dreamy Life</title>
      </Head>
      <style>{`
      ...
      >
            ...
            {[...Array(20)].map((_, i) => (
              <div
                ...
                style={{
                  ...
                  backgroundColor: ['#a855f7', '#ec4899', '#14b8a6', '#f97316', '#06b6d4', '#f43f5e'][i % 6],
        ...
        <div className="bg-white/80 backdrop-blur-3xl rounded-[2rem] p-8 w-full max-w-md border border-white/40 shadow-2xl text-center">
          {status === 'loading' && (
            <div className="py-8">
              <div className="w-16 h-16 mx-auto mb-6 rounded-full border-4 border-[#e9fdff] border-t-[#14b8a6] spin"></div>
          ...
          {status === 'success' && (
            <div className="py-4">
              ...
              <div className="fade-in-up-delay-2">
                <p className="text-xs text-[#45474b] mb-4">Redirecting to wallet in 5 seconds...</p>
                <Link
                  href="/wallet"
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-[#14b8a6] text-white font-semibold text-sm hover:bg-[#0d9488] transition-all shadow-lg shadow-[#14b8a6]/30"
                >
            ...
            <div className="py-4">
              ...
              <div className="flex gap-3 justify-center">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-[#14b8a6] text-white font-semibold text-sm hover:bg-[#0d9488] transition-all"
                >
