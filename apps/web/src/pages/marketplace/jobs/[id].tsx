    ...
    <>
      ...
      <div className="min-h-screen bg-[#fcf9f8]">
        ...
        <main className="pt-28 pb-20 px-4 md:px-6 max-w-[600px] mx-auto w-full">
          <div className="bg-white/50 backdrop-blur-[24px] rounded-2xl p-6 border border-white/30 mb-6">
          ...
          {job.type === 'single' && (
            <div className="mb-6">
              ...
              {!isPoster && !hasPendingBid && !hasAcceptedBid && job.status === 'active' && (
                <div className="bg-white/50 backdrop-blur-[24px] rounded-xl p-4 border border-white/30 mb-3">
                  <input
                    type="number"
                    placeholder="Your bid amount (৳)"
                    value={bidAmount}
                    onChange={(e) => setBidAmount(e.target.value)}
                    className="w-full bg-white/50 rounded-lg px-3 py-2 text-[14px] text-[#1c1b1b] placeholder:text-[#45474b]/50 border border-white/30 outline-none mb-2"
                  />
                  <input
                    type="text"
              ...
              {job.bids?.map((bid) => (
                <div key={bid.id} className="bg-white/50 backdrop-blur-[24px] rounded-xl p-4 border border-white/30 mb-2">
          ...
          {job.type === 'multiple' && (
            <div className="mb-6">
              ...
              {job.assignments?.map((a) => (
                <div key={a.id} className="bg-white/50 backdrop-blur-[24px] rounded-xl p-4 border border-white/30 mb-2">
          ...
          {job.submissions?.length > 0 && (
            <div className="mb-6">
              ...
              {job.submissions.map((s) => (
                <div key={s.id} className="bg-white/50 backdrop-blur-[24px] rounded-xl p-4 border border-white/30 mb-2">
                  <div className="flex justify-between items-center mb-1">
          ...
          {(hasAcceptedBid || myAssignment) && job.status === 'in_progress' && !hasPendingSubmission && (
            <div className="mb-6">
              ...
              <div className="bg-white/50 backdrop-blur-[24px] rounded-xl p-4 border border-white/30">
                <textarea
                  placeholder="Describe your work completion..."
                  value={proof}
                  onChange={(e) => setProof(e.target.value)}
                  rows={4}
                  className="w-full bg-white/50 rounded-lg px-3 py-2 text-[14px] text-[#1c1b1b] placeholder:text-[#45474b]/50 border border-white/30 outline-none resize-none mb-2"
                />
                <button
