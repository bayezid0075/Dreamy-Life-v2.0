# Generated by Django 5.2.7 on 2025-10-06 09:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('own_refercode', models.CharField(editable=False, max_length=8, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member_status', models.CharField(choices=[('user', 'user'), ('Basic', 'Basic'), ('Standard', 'Standard'), ('Smart', 'Smart'), ('VVIP', 'VVIP')], default='user', max_length=20)),
                ('profile_picture', models.CharField(blank=True, max_length=255, null=True)),
                ('is_verified', models.BooleanField(default=False)),
                ('address', models.TextField(blank=True, null=True)),
                ('nid_or_brid', models.CharField(blank=True, max_length=100, null=True)),
                ...
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('referred_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='direct_children', to=settings.AUTH_USER_MODEL)),
